...
SECRET_KEY = 'e7)&jgqll%nhtfmex=0jjo++eaui00#8b1z_#h((irepc@4edi'
...
ASGI_APPLICATION = "django_lesson.routing.application"

# https://djangopackages.org/grids/g/stripe/
